...
def endtest(request):
    if request.method == 'POST':
        ...
        p = Taks(test_ok=test_ok,user_id=user_id,contents_id=contents_id,total_test_time=total_test_time,test_date=test_date,chromosome_id=chromosome_id,user_id=user_id)
        p.save()
